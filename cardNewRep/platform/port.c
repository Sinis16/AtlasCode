 ...
 *******************************************************************************/
 ...
 #define IRQ_GPIO_PORT      "gpio0"    // P0.03
 #define IRQ_GPIO_PIN       3
 #define IRQ_GPIO_FLAGS     GPIO_INPUT
 
 #define WAKEUP_GPIO_PORT   "gpio0"    // P0.29
 #define WAKEUP_GPIO_PIN    29
 #define WAKEUP_GPIO_FLAGS  GPIO_OUTPUT
 
 #define RESET_GPIO_PORT    "gpio0"    // P0.28
 #define RESET_GPIO_PIN     28
 #define RESET_GPIO_FLAGS   GPIO_OUTPUT
 
 #define RX_LED_GPIO_PORT   "gpio0"    // P0.06
 #define RX_LED_GPIO_PIN    6
 #define RX_LED_GPIO_FLAGS  GPIO_OUTPUT
 
 #define TX_LED_GPIO_PORT   "gpio0"    // P0.07
 #define TX_LED_GPIO_PIN    7
 #define TX_LED_GPIO_FLAGS  GPIO_OUTPUT
 
 #define POL_GPIO_PORT      "gpio0"    // P0.08
 #define POL_GPIO_PIN       8
 #define POL_GPIO_FLAGS     GPIO_OUTPUT_INACTIVE
 
 #define PHA_GPIO_PORT      "gpio0"    // P0.09
 #define PHA_GPIO_PIN       9
 #define PHA_GPIO_FLAGS     GPIO_OUTPUT_INACTIVE
...
int peripherals_init(void)
{
    ...
    tx_led_dev = device_get_binding(TX_LED_GPIO_PORT); // Fixed: was RX_LED_GPIO_PORT
    if (!tx_led_dev) {
