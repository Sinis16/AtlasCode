...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DF_CONNECTION_CTE_TX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DF_CONNECTION_CTE_RSP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DF_CTE_TX_AOD, 1);
