...
#define RESP_TX_TO_FINAL_RX_DLY_UUS 2000
    ...
    while (1) {
        ...
        if (status_reg & SYS_STATUS_RXFCG_BIT_MASK) {
            ...
            if (memcmp(rx_buffer, rx_poll_msg, ALL_MSG_COMMON_LEN) == 0) {
                ...
                dwt_setrxtimeout(ctx, FINAL_RX_TIMEOUT_UUS);
                ...
                int ret = dwt_starttx(ctx, DWT_START_TX_IMMEDIATE | DWT_RESPONSE_EXPECTED);
                ...
                if (status_reg & SYS_STATUS_RXFCG_BIT_MASK) {
                    ...
                    if (memcmp(rx_buffer, rx_final_msg, ALL_MSG_COMMON_LEN) == 0) {
                        ...
                        resp_tx_ts = get_tx_timestamp_u64(ctx);
                        final_rx_ts = get_rx_timestamp_u64(ctx);
                        ...
                        //LOG_INF("[Atlas] Displaying tof: %3.6f s", tof);
                        LOG_INF("[Atlas] Displaying distance: %3.2f m", distance);
                    } else {
