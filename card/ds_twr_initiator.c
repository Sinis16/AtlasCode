...
int app_main(void)
{
    ...
    /* Set RX delays and timeouts */
    dwt_setrxaftertxdelay(POLL_TX_TO_RESP_RX_DLY_UUS);
    dwt_setrxtimeout(RESP_RX_TIMEOUT_UUS);
    dwt_setpreambledetecttimeout(PRE_TIMEOUT);

    /* Enable TX/RX states on GPIOs and LEDs */
    ...
    while (1) {
        ...
        /* Start transmission, expecting a response */
        dwt_starttx(DWT_START_TX_IMMEDIATE | DWT_RESPONSE_EXPECTED);

        /* Poll for reception or error/timeout */
        ...
        Sleep(RNG_DELAY_MS); // 1 sec delay between polls
    }
}
/*****************************************************************************************************************************************************
 * NOTES:
